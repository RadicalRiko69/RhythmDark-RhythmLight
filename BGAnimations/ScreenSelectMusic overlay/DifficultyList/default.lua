...
t[#t+1] = Def.ActorFrame{
	Def.StepsDisplayList {
		...
		InitCommand=cmd(draworder,250;x,-42;y,-200;zoom,0.625);
		...
		CursorP2 = Def.ActorFrame {
			...
			LoadActor("player2cur")..{
				InitCommand=cmd(x,-9;y,-5;zoom,0.55;thump,1;effectmagnitude,1,1.05,4;effectclock,'beat';visible,GAMESTATE:IsSideJoined(PLAYER_2););
				--[[OnCommand=function(self)
		...
		CursorP1 = Def.ActorFrame {
			...
			InitCommand=cmd(x,-9;y,-5;zoom,0.55;thump,1;sleep,1;effectmagnitude,1,1.05,4;effectclock,'beat';);
			};
		};
