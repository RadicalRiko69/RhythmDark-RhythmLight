...
t[#t+1] = Def.ActorFrame{
	...
	LoadActor("out/get ready")..{
		...
		OffCommand=cmd(linear,0.25;diffusealpha,1;zoom,0.325;decelerate,0.25;zoom,0.4;decelerate,0.25;zoom,0.325);
	};
};
...
t[#t+1] = Def.ActorFrame {
	InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_CENTER_Y;diffusealpha,0;zoom,2;decelerate,0.5;zoom,1;diffusealpha,0);
	...
	Def.Quad {
	  ...
	  Def.ActorFrame {
		  LoadActor("out/scan") .. {
			OffCommand=cmd(zoom,0.7;x,SCREEN_CENTER_X-220;y,SCREEN_CENTER_Y-500;diffusealpha,1;linear,10;y,SCREEN_CENTER_Y+100);
		  };
		  LoadActor("out/fence") .. {
