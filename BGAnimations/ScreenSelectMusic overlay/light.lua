...
t[#t+1] = Def.ActorFrame{
	LoadFont("_chiaro 36px")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_BOTTOM-30;zoom,0.8;diffusealpha,0;strokecolor,Color("Black");sleep,2;decelerate,1;diffusealpha,1);
	...
	LoadFont("_chiaro 36px")..{
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_TOP+30;zoom,1;diffusealpha,0;strokecolor,Color("Black");sleep,2;decelerate,1;diffusealpha,1);
		OnCommand=function(self)
	...
	LoadFont("_chiaro 36px")..{
		...
		InitCommand=cmd(x,SCREEN_CENTER_X;y,SCREEN_TOP+10;zoom,0.5;diffusealpha,0;strokecolor,Color("Black"));
...
t[#t+1] = Def.Quad {
	OnCommand=cmd(Center;zoomto,SCREEN_WIDTH,SCREEN_HEIGHT;diffuse,Color("White");diffusealpha,0);
	OffCommand=cmd(decelerate,2;diffusealpha,1);
};
