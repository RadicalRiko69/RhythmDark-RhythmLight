...
t[#t+1] = LoadFont("_enigmatic unicode 20px")..{	
	InitCommand=cmd(xy,SCREEN_RIGHT-90,SCREEN_BOTTOM-30;zoom,1;diffusealpha,1;skewx,-0.2);
	OnCommand=cmd(decelerate,0.5;zoomy,0;diffusealpha,0);
	Text="LOADING...";
};
