...
local t = Def.ActorFrame {
	...
	ComboCommand=function(self, param)
		...
		param.Zoom = scale( iCombo, 0, NumberMaxZoomAt*2, NumberMinZoom*2, NumberMaxZoom*2 );
		param.Zoom = clamp( param.Zoom, NumberMinZoom*2, NumberMaxZoom*2 );
